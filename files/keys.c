...
{
	if (data->array[data->level][(int)(POS_Y)][(int)(POS_X
		- DIR_X * data->speed)] == 0)
		POS_X -= DIR_X * data->speed;
	if (data->array[data->level][(int)(POS_Y - DIR_Y
...
void	key_a(t_data *data)
{
	...
	if (data->array[data->level][(int)(POS_Y + diry * data->speed)]
		[(int)(POS_X)] == 0)
...
void	key_d(t_data *data)
{
	...
	if (data->array[data->level][(int)(POS_Y)][(int)(POS_X
		+ dirx * data->speed)] == 0)
		POS_X += dirx * data->speed;
	if (data->array[data->level][(int)(POS_Y + diry
		* data->speed)][(int)(POS_X)] == 0)
		POS_Y += diry * data->speed;
}
